# This is the centos 8 version of [(*CM2Walki's steamcmd*)](https://github.com/CM2Walki/steamcmd)
# Supported tags and respective `Dockerfile` links
  -	[`steam`,`user`, `latest` (*user/Dockerfile*)](https://github.com/menesakdeniz/steamcmd/blob/main/user/Dockerfile)
  -	[`root` (*root/Dockerfile*)](https://github.com/menesakdeniz/steamcmd/blob/main/root/Dockerfile)
...
```console
$ docker run -it --name=steamcmd menesakdeniz/steamcmd bash
